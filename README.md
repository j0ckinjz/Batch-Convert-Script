...
### Latest version of HandbrakeCLI.exe is too big to upload. Download the CLI from their website and replace version in /bin folder. Version 0.10.5 will crash a lot. 1.0.7 works better.
